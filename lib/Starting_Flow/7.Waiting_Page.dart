...
class _waitState extends State<wait> {
  ...
  void initState() {
    ...
    super.initState();
    if (check == true) {
      timer = Timer.periodic(Duration(seconds: 3), (_) => route());
    }
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Image.asset('assets/power1.png', height: 250),
                ],
              ),
            ],
          ),
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.pushReplacement(context,
                        MaterialPageRoute(builder: (context) => user_data()));
                  },
                  child: Text(
                    "Leave",
                    style: GoogleFonts.aBeeZee(
